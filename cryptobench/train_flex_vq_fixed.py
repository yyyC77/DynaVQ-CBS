...
def _maybe_build_indexed_holo_annotations(test_paths: dict, out_dir: Path) -> bool:
    ...
    summary = {
        "auto_built_by": "cryptobench.train_flex_vq_fixed",
    ...
    (ann_dir / "README.md").write_text(
        ...
        "Auto-generated by `cryptobench.train_flex_vq_fixed` from a holo pipeline. "
...
def main() -> None:
    ...
    config = {
        "runner": "cryptobench.train_flex_vq_fixed",
        "fixed_model": "B1+Flex+VQ",
