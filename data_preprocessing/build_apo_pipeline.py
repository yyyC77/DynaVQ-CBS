...
def main():
    ...
    ap.add_argument("--dataset_json", type=Path, default=Path("cryptobench/cryptobench-dataset/dataset.json"))
    ap.add_argument("--cif_dir", type=Path, default=Path("cryptobench/cryptobench-dataset/auxiliary-data/cif-files"))
    ap.add_argument("--folds_dir", type=Path, default=Path("cryptobench/cryptobench-dataset/folds"))
    ap.add_argument("--out_dir", type=Path, default=Path("cryptobench/pipeline_v2"))
